...
\createTitlePage{فصل پنجم}{تولید شرح متناظر صحنه با استفاده از روش‌های مبتنی بر توجه بصری}
\include{attentionBasedImageCaptioning}
	
\createTitlePage{فصل ششم}{حافظه فعال و مقایسه آن با مدل‌های مبتنی بر توجه بصری}
