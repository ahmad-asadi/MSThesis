...
\createTitlePage{فصل چهارم}{تولید شرح متناظر صحنه با استفاده از یادگیری عمیق}
\include{deepImageCaptioning}

\createTitlePage{فصل پنجم}{تولید شرح متناظر صحنه با استفاده از روش‌های مبتنی بر نقطه توجه}
\include{attentionBasedImageCaptioning}

\createTitlePage{فصل ششم}{تولید شرح متناظر صحنه با استفاده از روش‌های مبتنی بر حافظه فعال}
\include{activeMemoryBasedImageCaptioning}

\createTitlePage{فصل هفتم}{جمع‌بندی و نتیجه‌گیری}
\include{conclusion}
